...
test('Matrix equality with identical matrices', () => {
    ...
    const matrix2 = new Matrix(elements);
...
test('Matrix equality with different matrices', () => {
    ...
    const matrix2 = new Matrix(elements2);
...
test('Multiplying two matrices', () => {
    ...
    const matrix1 = new Matrix(A);
    const matrix2 = new Matrix(B);
    const matrixProduct = new Matrix(product);
...
test('multiplying a matrix byt the identity matrix', () => {
    ...
    expect(matrix.multiply(Matrix.Identity())).toEqual(matrix);
});
...
test('transposing a matrix', () => {
    ...
    const matrixT = new Matrix(transposeA);

    expect(matrix.transpose()).toEqual(matrixT);
});

test('transposing the identity matrix', () => {
    expect(Matrix.Identity().transpose()).toEqual(Matrix.Identity());
});
