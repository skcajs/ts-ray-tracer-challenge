import Tuple, {makeBlack, makeColor, parseColor} from "./tuple.ts";
...
export default class Material {
    ...
    lighting(light: PointLight, point: Tuple, eyeV: Tuple, normalV: Tuple): Tuple {
        let diffuse = makeBlack();
        let specular = makeBlack();
